...
const ScenarioEngine: React.FC<ScenarioEngineProps> = ({ 
  ...
  const [conversationHistory, setConversationHistory] = useState<Array<{ speaker: string; text: string; translation: string }>>([]);
  ...
  const [showPronunciationPanel, setShowPronunciationPanel] = useState<boolean>(false);
    ...
    if (scenario === 'restaurant' && language === 'mandarin') {
      return {
        start: {
          ...
          npcTranslation: 'Hello! Welcome to our Sichuan restaurant! How many people?',
          options: [
            {
              id: 'two_people',
              text: '两位，谢谢。',
            ...
            },
            {
              ...
              points: 15,
              nextScene: 'seating',
              culturalNote: 'Asking about wait times shows consideration and is appreciated.'
            }
          ],
          vocabulary: [
            { word: '欢迎', pronunciation: 'huānyíng', meaning: 'welcome' },
            { word: '几位', pronunciation: 'jǐ wèi', meaning: 'how many people' },
            { word: '等位', pronunciation: 'dǒng wèi', meaning: 'wait for a table' }
          ]
        },
        seating: {
          id: 'seating',
          ...
          npcPronunciation: 'Hǎo de, qǐng gēn wǒ lái. Nín xiǎng zuò kào chuāng de wèizi ma?',
          npcTranslation: 'Alright, please follow me. Would you like to sit by the window?',
          options: [
            {
              id: 'window_yes',
              text: '好的，靠窗很好。',
            ...
            },
            {
              ...
              points: 15,
              nextScene: 'menu',
              culturalNote: 'Asking for specific seating preferences is perfectly acceptable.'
            }
          ]
        },
        menu: {
          ...
          npcName: 'Server',
          npcEmoji: '👩‍🍳',
          npcDialogue: '您好！我是您的服务员。您想点些什么？我们的麻婆豆腐和宫保鸡丁很有名。',
          npcPronunciation: 'Nín hǎo! Wǒ shì nín de fúwùyuán. Nín xiǎng diǎn xiē shénme? Wǒmen de mápó dòufu hé gōngbǎo jīdīng hěn yǒumíng.',
          npcTranslation: 'Hello! I\'m your server. What would you like to order? Our Mapo Tofu and Kung Pao Chicken are famous.',
          options: [
            {
              id: 'ask_spicy',
              text: '麻婆豆腐很辣吗？',
            ...
            },
            {
              ...
              translation: 'Can you recommend some dishes that aren\'t too spicy?',
              points: 20,
              nextScene: 'recommendations',
              culturalNote: 'Asking for recommendations shows respect for local expertise.'
            }
          ],
          vocabulary: [
            { word: '服务员', pronunciation: 'fúwùyuán', meaning: 'server/waiter' },
            { word: '点菜', pronunciation: 'diǎn cài', meaning: 'to order food' },
        ...
        spice_level: {
          ...
          npcName: 'Server',
          npcEmoji: '👩‍🍳',
          npcDialogue: '麻婆豆腐确实比较辣。我们可以做得不那么辣，您觉得怎么样？',
          npcPronunciation: 'Mápó dòufu quèshí bǐjiào là. Wǒmen kěyǐ zuò de bù nàme là, nín juéde zěnmeyàng?',
          npcTranslation: 'Mapo Tofu is indeed quite spicy. We can make it less spicy, what do you think?',
          options: [
            {
              id: 'less_spicy',
              text: '好的，请做得不那么辣。',
            ...
            },
            {
              ...
              points: 20,
              nextScene: 'drinks',
              culturalNote: 'Appreciating authentic flavors is highly respected in Chinese culture.'
            }
          ]
        },
        recommendations: {
          ...
          npcPronunciation: 'Dāngrán! Wǒ tuījiàn wǒmen de tángcù lǐjǐ hé báiqiē jī, dōu bù là, wèidào hěn hǎo.',
          npcTranslation: 'Of course! I recommend our Sweet and Sour Pork and White Cut Chicken, both are not spicy and taste great.',
          options: [
            {
              id: 'order_sweet_sour',
              text: '那我要糖醋里脊。',
        ...
        drinks: {
          ...
          npcPronunciation: 'Hǎo de. Nín xiǎng hē diǎn shénme? Wǒmen yǒu chá, guǒzhī, hái yǒu píjiǔ.',
          npcTranslation: 'Alright. What would you like to drink? We have tea, juice, and beer.',
          options: [
            {
              id: 'order_tea',
              text: '我要一壶茉莉花茶。',
              ...
              points: 15,
              nextScene: 'payment',
              culturalNote: 'Tea is a traditional and respectful choice with Chinese meals.'
            },
            {
              id: 'order_beer',
              text: '给我一瓶青岛啤酒。',
          ...
          vocabulary: [
            ...
            { word: '茉莉花茶', pronunciation: 'mòlì huā chá', meaning: 'jasmine tea' }
          ]
        },
        tea_selection: {
          id: 'tea_selection',
          ...
          npcName: 'Server',
          npcEmoji: '👩‍🍳',
          npcDialogue: '我们有茉莉花茶，普洱茶，铁观音，还有龙井茶。哪种您比较喜欢？',
          npcPronunciation: 'Wǒmen yǒu mòlì huā chá, pǔ\'ěr chá, tiěguānyīn, hái yǒu lóngjǐng chá. Nǎ zhǒng nín bǐjiào xǐhuān?',
          npcTranslation: 'We have jasmine tea, pu-erh tea, tieguanyin, and longjing tea. Which one do you prefer?',
          options: [
            {
              id: 'choose_longjing',
              text: '龙井茶听起来不错。',
              ...
              points: 20,
              nextScene: 'payment',
              culturalNote: 'Longjing is a famous green tea from Hangzhou, showing good taste.'
            },
            {
              id: 'choose_puer',
              text: '普洱茶可以帮助消化吗？',
        ...
        tea_benefits: {
          ...
          npcPronunciation: 'Duì de! Pǔ\'ěr chá quèshí yǒuzhù yú xiāohuà, tèbié shì chī le yóunì de shíwù zhīhòu.',
          npcTranslation: 'Yes! Pu-erh tea indeed helps with digestion, especially after eating greasy food.',
          options: [
            {
              id: 'order_puer',
              text: '那就普洱茶吧。',
        ...
        explanation: {
          ...
          npcName: 'Server',
          npcEmoji: '👩‍🍳',
          npcDialogue: '白切鸡是用白水煮熟的鸡肉，然后配上蘸料。非常嫩滑，很健康。',
          npcPronunciation: 'Báiqiē jī shì yòng bái shuǐ zhǔ shú de jīròu, ránhòu pèi shàng zhàn liào. Fēicháng nèn huá, hěn jiànkāng.',
          npcTranslation: 'White cut chicken is chicken boiled in plain water, then served with dipping sauce. Very tender and healthy.',
          options: [
            {
        ...
        sauce_explanation: {
          ...
          npcPronunciation: 'Zhàn liào shì yòng shēng chōu, xiāng yóu, jiāng sī hé cōng huā tiáozhì de. Wèidào hěn xiānměi.',
          npcTranslation: 'The dipping sauce is made with light soy sauce, sesame oil, ginger strips and scallions. It\'s very flavorful.',
          options: [
            {
              id: 'sounds_good',
              text: '那我要白切鸡。',
        ...
        payment: {
          ...
          npcPronunciation: 'Hǎo de, nín de cài mǎshàng jiù hǎo. Yòngcān yúkuài! Shāohòu wǒ huì bǎ zhàngdān gěi nín.',
          npcTranslation: 'Alright, your food will be ready soon. Enjoy your meal! I\'ll bring you the bill later.',
          options: [
            {
              id: 'thank_you',
              text: '谢谢您的服务！',
    ...
    if (scenario === 'restaurant' && language === 'malay') {
      return {
        start: {
          ...
          options: [
            ...
            },
            {
              ...
              points: 20,
              nextScene: 'recommendations',
              culturalNote: 'Asking for recommendations shows you value local knowledge.'
            }
          ],
          vocabulary: [
        ...
        menu: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Ini menu kita. Nasi lemak, mee goreng, roti canai semua ada. Apa yang awak mau?',
          npcTranslation: 'Here\'s our menu. We have nasi lemak, mee goreng, roti canai, everything. What do you want?',
          options: [
            {
              id: 'order_nasi_lemak',
            ...
            },
            {
              ...
              culturalNote: 'Asking about halal food shows cultural awareness in Malaysia.'
            }
          ],
          vocabulary: [
        ...
        recommendations: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Kalau first time datang, mee goreng mamak dan roti pisang memang sedap. Nasi lemak pun boleh tahan.',
          npcTranslation: 'If it\'s your first time here, mee goreng mamak and roti pisang are really delicious. Nasi lemak is also quite good.',
          options: [
            {
            ...
            },
            {
              ...
              culturalNote: 'Ordering dessert shows you understand Malaysian dining culture.'
            },
            {
              ...
              culturalNote: 'Trusting the mamak uncle shows respect and often gets you the best food!'
            }
          ]
        },
        mee_goreng_explanation: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Mee goreng mamak ada sayur, telur, tauhu, dan sambal kicap. Rasa manis sikit, memang best!',
          npcTranslation: 'Mee goreng mamak has vegetables, egg, tofu, and sweet soy sauce sambal. It\'s slightly sweet, really good!',
          options: [
            {
              id: 'order_mee_goreng',
        ...
        uncle_choice: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Bagus! Saya buatkan nasi lemak special dengan ayam rendang dan sambal sotong. Confirm sedap!',
          npcTranslation: 'Good! I\'ll make you special nasi lemak with rendang chicken and sambal squid. Guaranteed delicious!',
          options: [
            {
              id: 'excited',
        ...
        spice_warning: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Wah, extra pedas memang panas! Orang Malaysia pun ada yang tak tahan. Sure ka?',
          npcTranslation: 'Wow, extra spicy is really hot! Even some Malaysians can\'t handle it. Are you sure?',
          options: [
            {
              ...
              points: 30,
              nextScene: 'drinks',
              culturalNote: 'Taking on the spice challenge shows courage and adventurous spirit!'
            },
            {
              id: 'play_safe',
        ...
        drinks: {
          ...
          npcTranslation: 'What do you want to drink? Teh tarik, coffee, or plain water?',
          options: [
            {
              id: 'teh_tarik',
              ...
              points: 20,
              nextScene: 'payment',
              culturalNote: 'Specifying sweetness level shows you know local preferences.'
            },
            {
              id: 'kopi',
        ...
        drinks_recommendation: {
          ...
          npcName: 'Mamak Uncle',
          npcEmoji: '👨‍🍳',
          npcDialogue: 'Teh tarik memang signature drink kita. Kalau nak yang sejuk, try teh o ais limau. Very refreshing!',
          npcPronunciation: 'Teh tarik is definitely our signature drink. If you want something cold, try teh o ais limau. Very refreshing!',
          npcTranslation: 'Teh tarik is our signature drink. For something cold, try teh o ais limau—it’s very refreshing!',
          options: [
            {
              id: 'order_signature',
            ...
            },
            {
              ...
              points: 20,
              nextScene: 'payment',
              culturalNote: 'Trying local specialties shows cultural curiosity!'
            }
          ]
        },
        payment: {
          ...
          options: [
            {
              ...
              points: 20,
              nextScene: 'complete',
              culturalNote: 'Small tips are appreciated but not expected at mamak stalls.'
            },
            {
              id: 'pay_card',
    ...
    if (scenario === 'restaurant' && language === 'cantonese') {
      return {
        start: {
          ...
          npcEmoji: '👨‍💼',
          npcDialogue: '歡迎晒！幾多位？',
          npcPronunciation: 'fūn yìhng saai! géi dō wái?',
          ...
          vocabulary: [
            ...
            { word: '幾多位', pronunciation: 'géi dō wái', meaning: 'how many people' },
            { word: '等位', pronunciation: 'dáng wái', meaning: 'wait for table' }
          ]
        },
        seating: {
          id: 'seating',
          ...
          npcPronunciation: 'hóu, chéng gān ngóh làih. néih séung chóh bīn douh? chēung bīn dihng haih yahp mihn?',
          npcTranslation: 'Alright, please follow me. Where would you like to sit? By the window or inside?',
          options: [
            {
              id: 'window_seat',
              text: '窗邊好啲，可以睇風景。',
        ...
        menu: {
          ...
          npcPronunciation: 'séung sihk dī mē dím sām? ngóh deih ge sīu máai tùhng màaih hā gáau hóu chēut mìhng gaa.',
          npcTranslation: 'What dim sum would you like? Our siu mai and har gow are very famous.',
          options: [
            {
              id: 'order_classics',
              text: '我要燒賣同埋蝦餃。',
        ...
        recommendations: {
          ...
          npcPronunciation: 'hóu! gām yaht ngóh deih yáuh hóu jeng ge sīu máaih tùhng màaih chā sīu bāau. néih séung si hah mā?',
          npcTranslation: 'Great! Today we have excellent siu mai and char siu bao. Would you like to try?',
          options: [
            {
          ...
          vocabulary: [
            { word: '燒賣', pronunciation: 'sīu máaih', meaning: 'siu mai (pork dumpling)' },
            { word: '叉燒包', pronunciation: 'chā sīu bāau', meaning: 'char siu bao (BBQ pork bun)' },
            { word: '籠', pronunciation: 'lúhng', meaning: 'basket (for dim sum)' },
        ...
        vegetarian_options: {
          ...
          npcPronunciation: 'néih sihk m̀h sihk yuhk? yùh gwó m̀h sihk yuhk, ngóh deih yáuh sou choi gáau jí tùhng màaih lòh baahk gōu.',
          npcTranslation: 'Do you eat meat? If you don\'t eat meat, we have vegetable dumplings and radish cake.',
          options: [
            {
              id: 'vegetarian',
              text: '我係素食者，要素菜餃子。',
          ...
          vocabulary: [
            { word: '素食者', pronunciation: 'sou sihk jé', meaning: 'vegetarian' },
            { word: '素菜餃子', pronunciation: 'sou choi gáau jí', meaning: 'vegetable dumplings' },
            { word: '蘿蔔糕', pronunciation: 'lòh baahk gōu', meaning: 'radish cake' },
            { word: '點樣', pronunciation: 'dím yéung', meaning: 'how/what like' }
          ]
        },
        tea: {
          id: 'tea',
          ...
          npcPronunciation: 'yám mē chàh hóu? póu léi, tit gun yām dihng haih muht leih fā chàh?',
          npcTranslation: 'What tea would you like? Pu-erh, tieguanyin, or jasmine tea?',
          options: [
            {
              id: 'pu_erh',
              text: '普洱茶，唔該。',
              ...
              points: 15,
              nextScene: 'payment',
              culturalNote: 'Pu-erh is traditional with dim sum as it aids digestion.'
            },
            {
              id: 'jasmine',
              text: '茉莉花茶好啲。',
  ...
  const handleOptionSelect = (option: DialogueOption) => {
    ...
    if (option.nextScene === 'complete' || !option.nextScene) {
      setTimeout(() => onComplete(score + option.points), 1000);
    } else if (option.nextScene && scenarioData[option.nextScene]) {
      setTimeout(() => {
        setCurrentScene(option.nextScene!);
        // Add NPC response to history
        const nextScene = scenarioData[option.nextScene!];
        setConversationHistory(prev => [
          ...prev,
          {
  ...
  const playAudio = async (text: string, autoPlay: boolean = false) => {
    ...
    try {
      ...
      if (response.ok && response.headers.get('content-type')?.includes('audio')) {
        ...
        audio.onloadeddata = () => {
          console.log('🔊 AWS Polly speech started:', text.substring(0, 20) + '...');
        };
      ...
      console.error('Error with AWS Polly, falling back to browser TTS:', error);
      fallbackToWebSpeech(text);
    }
  };
  ...
  const fallbackToWebSpeech = (text: string) => {
    if ('speechSynthesis' in window) {
      ...
      utterance.lang = language === 'mandarin' ? 'zh-CN' : language === 'malay' ? 'ms-MY' : 'zh-HK';
      utterance.rate = 0.8;
      utterance.pitch = 1.0;
      utterance.volume = 1.0;

      utterance.onstart = () => {
        console.log('🔊 Browser TTS speech started:', text.substring(0, 20) + '...');
      };
  ...
  const checkPronunciation = async (expectedText: any, recordedBlob: Blob) => {
    ...
    try {
      ...
      const transcribeResponse = await fetch('http://localhost:5000/api/speech-to-text', {
        method: 'POST',
        body: formData,
      });
      ...
      const transcriptionResponse = await fetch(`http://localhost:5000/api/speech-to-text/job/${jobName}/signed-url`);

      if (!transcriptionResponse.ok) {
        throw new Error(`Failed to fetch transcription text: ${transcriptionResponse.status}`);
      }
      ...
      if (!pronunciationResponse.ok) {
        throw new Error(`Pronunciation check failed: ${pronunciationResponse.status}`);
      }
      ...
      setPronunciationFeedback(pronunciationResult.feedback || 'Assessment completed');
      setShowPronunciationPanel(true);

    } catch (error) {
      console.error('Error checking pronunciation:', error);
      setPronunciationScore(0.5); // Give a neutral score on error
      setPronunciationFeedback(`Error: ${error.message}. Please try recording again.`);
      setShowPronunciationPanel(true);
    } finally {
  ...
  const pollTranscriptionJob = async (jobName: string, isMock: boolean = false): Promise<string> => {
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
      try {
        ...
        if (result.TranscriptionJob.TranscriptionJobStatus === 'COMPLETED') {
          const transcript = result.TranscriptionJob.Transcript.results?.transcripts?.[0]?.transcript;
        ...
        <div className="flex items-center space-x-2">
          <button 
            ...
            className={`px-3 py-1 rounded text-sm transition-colors ${
              autoPlayEnabled ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-600 hover:bg-gray-700'
            }`}
          >
          ...
          <button 
            ...
            className={`px-3 py-1 rounded text-sm transition-colors ${
              showPronunciationPanel ? 'bg-purple-600 hover:bg-purple-700' : 'bg-gray-600 hover:bg-gray-700'
            }`}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-full">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className="text-4xl mb-2">{currentSceneData.background}</div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="font-bold text-blue-300">{currentSceneData.npcName}:</span>
                      <button 
                        onClick={() => playAudio(currentSceneData.npcDialogue)}
                        className={`transition-colors ${
                          isPlaying ? 'text-green-400 hover:text-green-300' : 'text-blue-400 hover:text-blue-300'
                        }`}
                    ...
                    <p className="text-lg mb-1">{currentSceneData.npcDialogue}</p>
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-bold text-purple-300 mb-3">Choose your response:</h3>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        {showTranslation && (
                          <p className="text-gray-200 text-sm">"{option.translation}"</p>
                        )}
                        {option.culturalNote && (
                      ...
                      <div className="text-right ml-4">
                        <div className="text-yellow-400 font-bold mb-1">+{option.points}</div>
          ...
          <div className="space-y-6">
            ...
            {showPronunciationPanel && (
              ...
              >
                <h3 className="text-lg font-bold text-purple-400 mb-3">🎤 Pronunciation Practice</h3>
                
                {/* Current NPC Dialogue Practice */}
                <div className="bg-gray-700/50 rounded-lg p-3 mb-4">
                  <p className="text-sm text-gray-300 mb-2">Practice saying:</p>
                  <p className="font-medium text-lg mb-1">{currentSceneData.npcDialogue}</p>
                  {currentSceneData.npcPronunciation && (
                    <p className="text-gray-400 text-sm italic mb-2">{currentSceneData.npcPronunciation}</p>
                  )}
                  {showTranslation && (
                    <p className="text-gray-300 text-sm mb-3">"{currentSceneData.npcTranslation}"</p>
                  )}
                    ...
                    {recordedAudio && (
                      <button 
                        onClick={() => checkPronunciation({
                          chinese: currentSceneData.npcDialogue,
                          cantonese: currentSceneData.npcPronunciation,
                          english: currentSceneData.npcTranslation
                        }, recordedAudio)}
                  ...
                  {pronunciationScore !== null && (
                    <div className="bg-gray-600/50 rounded p-3">
                      ...
                      {pronunciationFeedback && (
                        <p className="text-sm text-gray-300">{pronunciationFeedback}</p>
                      )}
                    </div>
                  )}
                </div>
            ...
            {currentSceneData.vocabulary && (
              <motion.div 
                ...
                className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-4"
              >
                <h3 className="text-lg font-bold text-green-400 mb-3">📚 Key Vocabulary</h3>
                    ...
                    <div key={index} className="bg-gray-700/50 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          {item.pronunciation && (
                            <p className="text-gray-400 text-sm italic">{item.pronunciation}</p>
                          )}
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-700 rounded-full h-2 mt-3">
                  <div 
                    ...
                    style={{ width: `${(completedScenes.size / Object.keys(scenarioData).length) * 100}%` }}
                  ></div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h3 className="text-lg font-bold text-blue-400 mb-3">💬 Conversation</h3>
              <div className="space-y-3">
                {conversationHistory.map((entry, index) => (
                  <div key={index} className={`p-3 rounded-lg ${entry.speaker === 'You' ? 'bg-blue-600/30 ml-4' : 'bg-gray-700/50 mr-4'}`}>
                    <p className="font-medium text-sm text-gray-300">{entry.speaker}:</p>
                    <p className="text-sm">{entry.text}</p>
                    {showTranslation && (
                      <p className="text-xs text-gray-400 italic mt-1">"{entry.translation}"</p>
                    )}
                  </div>
                ))}
              </div>
